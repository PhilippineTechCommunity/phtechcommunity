...
class Mageewp_Control_Repeater extends WP_Customize_Control {
	...
	public function enqueue() {
				...
				if ( isset( $field['type'] ) ) {
					...
					switch ( $field['type'] ) {
						...
						case 'dropdown-pages':
							...
							wp_enqueue_style( 'mageewp-select2', CUSTOMIZER_LIB_URI . '/assets/vendor/select2/mageewp.css', null );
							break;
						case 'iconpicker':
							wp_enqueue_script( 'mageewp-fontawesome-iconpicker', get_stylesheet_directory_uri() . '/inc/customizer-library/custom-controls/iconpicker-control/assets/js/fontawesome-iconpicker.min.js', array( 'jquery' ), '1.0.0', true );
							wp_enqueue_script( 'mageewp-iconpicker-control', get_stylesheet_directory_uri() . '/inc/customizer-library/custom-controls/iconpicker-control/assets/js/iconpicker-control.js', array( 'jquery' ), '1.0.0', true );
							wp_enqueue_style( 'mageewp-fontawesome-iconpicker', get_stylesheet_directory_uri() . '/inc/customizer-library/custom-controls/iconpicker-control/assets/css/fontawesome-iconpicker.min.css' );
							wp_enqueue_style( 'mageewp-fontawesome', get_stylesheet_directory_uri() . '/inc/customizer-library/custom-controls/iconpicker-control/assets/css/font-awesome.min.css' );
						break;
		...
		wp_enqueue_script( 'mageewp-repeater', CUSTOMIZER_LIB_URI. '/custom-controls/repeater/repeater.js', array( 'jquery', 'customize-base', 'jquery-ui-core', 'jquery-ui-sortable' ), false, true );
		wp_enqueue_style( 'mageewp-repeater-css', CUSTOMIZER_LIB_URI . '/custom-controls/repeater/repeater.css', null );
	}
					...
					<# _.each( data, function( field, i ) { #>
						...
						<div class="repeater-field repeater-field-{{{ field.type }}}">
							...
							<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
								...
								<figure class="mageewp-image-attachment" data-placeholder="<?php esc_attr_e( 'No Image Selected', 'cactus' ); ?>" >
									<# if ( field.default ) { #>
							...
							<# } else if ( field.type === 'upload' ) { #>
								...
								<figure class="mageewp-file-attachment" data-placeholder="<?php esc_attr_e( 'No File Selected', 'cactus' ); ?>" >
									<# if ( field.default ) { #>
