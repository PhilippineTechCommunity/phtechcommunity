    ...
    <div class="cactus-box left <?php echo $hide1;?>">
      ...
      <div class="cactus-box-inner">
        <div class="cactus-box-content">
          <h2 class="cactus-section-title <?php echo 'section_title_'.$cactus_section_key.'_selective';?>"><?php echo wp_kses( $section_title , $allowedposttags );?></h2>
   		 <p class="cactus-section-desc <?php echo 'section_subtitle_'.$cactus_section_key.'_selective';?>"><?php echo wp_kses( $section_subtitle , $allowedposttags );?></p>                          
