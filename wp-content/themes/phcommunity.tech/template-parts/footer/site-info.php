...
<div class="footer-info-area style1 text-center <?php echo $hide1;?>">
	...
	<?php printf(__('Designed and developed by volunteers from <a href="%s" target="_blank">PWDO</a>','Philippine Web Designers Organization'),esc_url('http://2018.formfunctionclass.com/'));
		printf(__(',<a href="%s" target="_blank">WPUGPH</a> and the Philippine Tech Community. All Rights Reserved.','WordPress User Group Philippines'),esc_url('https://www.fb.com/wpugph'));
	?>
      </div>
    </div>
